...
class ShmPortArgs:
    ...
    @property
    def x2i_port(self) -> int:
        return self._get_from_args_or_alloc("x2i_port")

    @property
    def http_server_port_for_x2i(self) -> int:
        return self._get_from_args_or_alloc("http_server_port_for_x2i")

    @property
    def x2i_worker_nccl_port(self) -> int:
        return self._get_from_args_or_alloc("x2i_worker_nccl_port")

    @property
    def x2i_worker_task_port(self) -> int:
        return self._get_from_args_or_alloc("x2i_worker_task_port")

    @property
    def rl_control_response_port(self) -> int:
        return self._get_from_args_or_alloc("rl_control_response_port")
